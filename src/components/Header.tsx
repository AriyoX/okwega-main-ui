import { Bell, Menu, User, Compass, Settings, LogOut, HelpCircle } from 'lucide-react';
...
export function Header({ user, onMenuClick }: HeaderProps) {
  ...
  return (
    <header className="fixed top-0 right-0 left-0 z-50 bg-white border-b border-gray-200 shadow-sm h-16">
      <div className="h-16 px-4 flex items-center max-w-8xl mx-auto">
